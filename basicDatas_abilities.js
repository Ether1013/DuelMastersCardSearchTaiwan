	...
	const abilityMapping = {
		...
		init: function() {
			const initialData = [
				...
				{ Jap : "メガメテオバーン3",	Eng : "Mega Meteor Burn 3",		Chi : "百萬隕石爆擊3",		descript : "將進化生物下面的3張種子生物卡置入墓地以發動能力",},
				...
				{ Jap : "パワー・ガチンコ・ジャッジ",	Eng : "Power Gachingo Judge",			Chi : "力量勝負裁決",			descript : "與對手一起公開牌頂比卡牌攻擊力大小，只要發動方公開出來的卡片的費用數字沒有比對手小就算獲勝(沒有攻擊力則視為0)，之後將公開的牌放進牌庫底",},
				...
				{ Jap : "ニンジャ・ストライク",	Eng : "Ninja Strike",			Chi : "忍者奇襲",			descript : "每當對手生物發動攻擊或是阻擋時，如果自己的魔力區中有不低於指定數字張數的卡牌、且該次攻擊或阻擋當中，我方還沒有發動過任何其他的「ニンジャ・ストライク」能力的話，則可無視費用召喚此生物。\n於回合結束時，將以此能力出場的シノビ放回牌庫底。",},
				{ Jap : "ウラ・ニンジャ・ストライク",	Eng : "Inside Ninja Strike",			Chi : "裏・忍者奇襲",			descript : "每當對手生物發動攻擊或是阻擋時，如果自己的魔力區中有不低於指定數字張數的卡牌、並存在指定文明的卡牌、且該次攻擊或阻擋當中，我方還沒有發動過任何其他的「ニンジャ・ストライク」能力的話，則可無視費用召喚此生物。\n於回合結束時，將以此能力出場的シノビ放回牌庫底。",},
				...
				{ Jap : "スーパーガードマン",			Eng : "Super Guard Man",				Chi : "超級防禦者",				descript : "當對手生物與我方生物進行戰鬥時，你可以橫置此生物，這樣的話，則改由此生物與該對手生物進行戰鬥",},
				...
				{ Jap : "侵略",					Eng : "Invade",					Chi : "侵略",				descript : "當有指定條件的我方生物發動攻擊時，你可以將此生物置於該生物之上出場",	pop:true,},
				...
				{ Jap : "マナ進化V",			Eng : "Mana Evolution Vortex",			Chi : "魔力漩渦進化",		descript : "將此生物疊在我方魔力區中2張指定條件的生物之上出場",},
				{ Jap : "マナ進化GV",			Eng : "Mana Evolution Galaxy Vortex",		Chi : "魔力銀河漩渦進化",	descript : "將此生物疊在我方魔力區中3張指定條件的生物之上出場",},
				...
				{ Jap : "手札進化GV",				Eng : "Hand Evolution Galaxy Vortex",			Chi : "手牌進化GV",			descript : "將此生物疊在我方手牌中3張指定條件的生物之上出場",},
				...
				{ Jap : "革命チェンジ",			Eng : "Revolution Change",		Chi : "革命交替",			descript : "當指定條件的我方生物發動攻擊時，你可以將手牌中的此生物與發動攻擊的生物進行交換",	pop:true,},
				...
				{ Jap : "G-NEO進化",			Eng : "G-Neo Evolution",		Chi : "新進化G",			descript : "你可以將此生物置放在戰鬥場上1隻指定條件的生物之上。若此生物下方有生物卡牌的話，則將此生物視為NEO進化生物。當此生物離場時，若為進化生物的話，則取而代之、只將此生物下方所有卡牌離場。",},
				...
				{ Jap : "S-MAX進化",			Eng : "S-MAX Evolution",		Chi : "S-MAX進化",			descript : "當我方敗北時，你可以取而代之、破壞此生物或是手牌中的同名卡。(此生物不需要進化種，當戰鬥場上有2隻以上我方的S-MAX進化生物時，選擇其中1隻、並將其餘的拿回到手牌中)",},
				...
				{ Jap : "超無限墓地呪文進化",	Eng : "Super Endless Graveyard Spell Evolution",		
																				Chi : "超無限墓文呪文進化",	descript : "將此生物進化在我方墓地裡一張以上的咒文之上出場",},
				{ Jap : "ホールド・ナッシング・バック！",	
												Eng : "Hold Nothing Back",		Chi : "物盡不歸",			descript : "此生物出場時，此回合中、我方所有其他生物都可以攻擊重置狀態生物、且攻擊生物時不會被阻擋",},
				{ Jap : "ニンジャ・チェンジ",	Eng : "Ninja Change",			Chi : "忍變",				descript : "當對手生物攻擊或是阻擋時，該攻擊中如果還沒使用過ニンジャ能力的話，則你可從手牌中將此卡與指定費用以上的メカ或是シノビ進行交換",},
				{ Jap : "ニンジャ・K",	Eng : "Ninja Kick",			Chi : "忍踢",				descript : "當對手生物攻擊或是阻擋時，該攻擊中如果還沒使用過ニンジャ能力的話，則你可將場上指定費用以上的メカ或是シノビ拿回手牌、並不支付費用使用此卡牌",},
				...
				{ Jap : "Zラッシュ",				Eng : "Z Rush",			Chi : "Z突襲",				descript : "當有卡牌離開護盾區時，此生物進入超化狀態",},
				{ Jap : "G城",				Eng : "Galaxy Castle",			Chi : "銀河城",				descript : "此卡實行後、以表側方式護盾化。當此卡以表側方式離開護盾區時，取而代之、置入墓地",},
				...
				{ Jap : "跳次元召喚",		Eng : "Teleport Summon",		Chi : "跳次元召喚",	descript : "你可以視為已支付費用、從超次元區召喚一隻指定費用以下的生物，但是該生物的文明、我方魔力區都要有",},
