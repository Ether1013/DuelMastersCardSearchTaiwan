	...
	var updateLog = {
		...
		logAndDate : [
			{	
				date : "2024/08/09",
				log : [ 
						"新增DM24-BD1【ドリーム英雄譚デッキ ドギラゴンの書】的資料",
						"新增DM24-BD2【ドリーム英雄譚デッキ ジョニーの書】的資料"
				],	
			},
			{	
				date : "2024/08/02",
			...
			{	
				...
				log : [ 
						"調整過濾邏輯",
						"新增DMART-13【デュエマ×デュエプレ】的資料",
						"新增DMART-14【フェアリー・タイムライン】的資料",
						"新增DMART-15【激筆!!超獣戯画】的資料",
				],	
			},
			{	
				date : "2024/07/19",
				log : [ 
						"新增DM24-EX1【超感謝祭 ファンタジーBEST】的資料"
				],	
			},
		],
	};