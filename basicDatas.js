	...
	var updateLog = {
		...
		logAndDate : [
			{	
				date : "2023/06/17",
				log : [ 
						"調整「スーパー・S・トリガー」、「S・トリガー・プラス」、「キズナ」、「サバイバー」能力的相關寫法",
				],	
			},
			{	
				date : "2023/06/12",
				log : [ 
						"新增「スタートWINデッキ 聖沌・クノイチ・チェンジ」的內容。",
				],	
			},
			{	
				date : "2023/06/05",
				log : [ 
						"新增「帥狗盃DM大賽1st【5C龍風＠致舜】」的內容。",
						"新增「帥狗盃DM大賽2nd【龍霸VV8＠家華】」的內容。",
						"新增「帥狗盃DM大賽3rd【深淵＠可樂薯條】」的內容。",
						"新增「帥狗盃DM大賽4th【4C邪王門＠元丰】」的內容。",
				],	
			},
			{	
				date : "2023/05/31",
