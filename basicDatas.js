	...
	var updateLog = {
		...
		logAndDate : [
			{	
				date : "2023/04/28",
				log : [ 
						"新增「DM23-SP1 スタートWIN・スーパーデッキ 深淵の邪襲(先行版)」的資料",
				],	
			},
			{	
				date : "2023/04/25",
				log : [ 
						"新增「DM23-RP1 アビス・レボリューション 第1弾 「双竜戦記」」的資料",
				],	
			},
			{	
				date : "2023/04/20",
			...
			{	
				date : "2023/04/19",
				log : [ 
						"因應DMGP2023，新增Advance賽前八強所使用的卡牌資料",
				],	
			},
			{	
				date : "2023/04/17",
				log : [ 
						"新增「NET-059 DMGP2023-1st 『ラッカ鬼羅スターライオネル』＠ナオ@すずの音」的資料",
				],	
			},
		],
	};