...
//	var takaratomyRarityPicRoot = "http://dm.takaratomy.co.jp/card/list/images/newstyle/";
	...
	var cardTypeMapping = {
		...
		map : 
			[
				{	value : "C",	text : "生物",				Jap : "クリーチャー",						main:true,	},
				{	value : "EC",	text : "進化生物",			Jap : "進化クリーチャー",					main:true,	},
				...
				{	value : "PCG",	text : "次元交叉武裝",		Jap : "超次元クロスギア",					main:false,	descript : "裝備，支付費用即可裝備在生物身上。即便裝備此卡的生物離場時、此卡依然會留在場上"	},
				{	value : "CA",	text : "城",				Jap : "城",									main:false,	},
				{	value : "XC",	text : "放浪生物",			Jap : "エグザイル・クリーチャー",			main:false,	},
				{	value : "EXC",	text : "進化放浪生物",		Jap : "進化エグザイル・クリーチャー",		main:false,	},
				{	value : "PC",	text : "次元生物",			Jap : "サイキック・クリーチャー",			main:true,	},
				{	value : "EPC",	text : "次元進化生物",		Jap : "進化サイキック・クリーチャー",		main:false,	},
				{	value : "SPC",	text : "次元超級生物",		Jap : "サイキック・スーパー・クリーチャー",	main:false,	},
				{	value : "HF",	text : "幸福領域",			Jap : "幸せのフィールド",					main:false,	},
				{	value : "DHW",	text : "龍心武裝",			Jap : "ドラグハート・ウエポン",				main:true,	},
				{	value : "DHC",	text : "龍心生物",			Jap : "ドラグハート・クリーチャー",			main:true,	},
				{	value : "EDHC",	text : "進化龍心生物",		Jap : "進化ドラグハート・クリーチャー",		main:false,	},
				...
				{	value : "FSC",	text : "最終禁斷生物",		Jap : "最終禁断クリーチャー",				main:false,	},
				{	value : "FFF",	text : "最終禁斷領域",		Jap : "最終禁断フィールド",					main:false,	},
				{	value : "TS",	text : "魂種",				Jap : "タマシード",							main:true,	},
				{	value : "KCL",	text : "王的靈核",			Jap : "キング・セル",						main:true,	},
				{	value : "KC",	text : "王生物",			Jap : "キング・クリーチャー",				main:false,	},
	...
	var updateLog = {
		...
		logAndDate : [
			{	
				...
				log : [ 
						"網站搬遷完成",
						"訂正【深淵の壊炉 マーダン=ロウ】跟【カタパルト・チャージ】的能力。",
				],	
			},
			{	
				date : "2022/12/22",
				log : [ 
						"新增DM22-RP2【「轟炎の竜皇」超刺激パック】資料(FlavorText未翻譯)",
						"新增OF-Y22 SPP-1【スペシャルプロモパック2022 vol.1】，但是尚未視為台灣卡池",
				],	
			},
			{	
				date : "2022/12/19",
				log : [ 
						"訂正DM22-RP2【「轟炎の竜皇」】資料為台灣環境",
						"訂正DM22-SP2【「轟炎の竜皇」暴竜爵からの招待状】為台灣環境",
				],	
			},
			{	
				date : "2022/12/18",
				log : [ 
						"訂正【フェアリー・Re:ライフ】的卡種",
						"新增DM22-RP2【「轟炎の竜皇」】資料(FlavorText未翻譯)",
						"新增DM22-SP2【「轟炎の竜皇」暴竜爵からの招待状】(FlavorText未翻譯)",
				],	
			},
			{	
				date : "2022/12/15",
				log : [ 
						"訂正【真邪連結 バウ・M・ロマイオン】的文明",
				],	
			},
		],
	};