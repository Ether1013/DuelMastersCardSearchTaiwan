	...
	var updateLog = {
		...
		logAndDate : [
			{	
				date : "2024/04/12",
				log : [ 
						"訂正「CRYMAX ジャオウガ」的能力敘述",
						"調整「キリフダッシュ」的能力敘述",
						"新增DM24-RP1「王道篇第1弾 「デーモン・オブ・ハイパームーン」」"
				],	
			},
			{	
				date : "2024/04/08",
				log : [ 
						"新增DM24-SP1「キャラプレミアムデッキ「ドラゴン娘になりたくないっ！」 イェーイめっちゃドラゴン!!」",
						"新增DM24-SD1「いきなりつよいデッキ 攻めの王道」",
						"新增DM24-SD2「いきなりつよいデッキ 守りの王道」",
				],	
			},
			{	
				date : "2024/03/29",
				log : [ 
						"移除重複的能力註釋",
						"調整【神聖龍 エモーショナル・ハードコア】的能力敘述",
						"訂正【ガンバＧ/ガガン・ガン・ガガン】跟【真邪連結 バウ・M・ロマイオン】的資料",
				],	
			},
			{	
				date : "2024/03/27",
