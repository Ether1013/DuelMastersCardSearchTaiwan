...
//	var takaratomyRarityPicRoot = "http://dm.takaratomy.co.jp/card/list/images/newstyle/";
	...
	var cardTypeMapping = {
		...
		map : 
			[
				{	value : "C",	text : "生物",				Jap : "クリーチャー",						horizontal : false,	main:true,	},
				{	value : "EC",	text : "進化生物",			Jap : "進化クリーチャー",					horizontal : false,	main:true,	},
				{	value : "SEC",	text : "星進化生物",		Jap : "スター進化クリーチャー",				horizontal : false,	main:true,	},
				{	value : "SMEC",	text : "S-MAX進化生物",		Jap : "S-MAX進化クリーチャー",				horizontal : false,	main:true,	},
				{	value : "NC",	text : "NEO生物",			Jap : "NEOクリーチャー",					horizontal : false,	main:false,	descript : "當此生物下方有生物卡牌時，則將此生物視為進化生物"							},
				...
				{	value : "FFF",	text : "最終禁斷領域",		Jap : "最終禁断フィールド",					horizontal : true,	main:false,	},
				{	value : "MF",	text : "無月領域",			Jap : "無月フィールド",						horizontal : true,	main:false,	},
				{	value : "TS",	text : "魂種",				Jap : "タマシード",							horizontal : false,	main:true,	},
				{	value : "KCL",	text : "王的靈核",			Jap : "キング・セル",						horizontal : false,	main:true,	},
				{	value : "KC",	text : "王生物",			Jap : "キング・クリーチャー",				horizontal : false,	main:false,	},
	...
	var updateLog = {
		...
		logAndDate : [
			...
			{	
				...
				log : [ 
						"新增兩副「開發部特選牌組」先行版卡表",
						"新增港台交流賽2023卡表[NET-051][Z-File]",
						"新增港台交流賽2023卡表[NET-052][神官邪王門]",
						"新增港台交流賽2023卡表[NET-053][赤青阿波羅]",
				],	
			},
			{	
				date : "2023/03/05",
				log : [ 
						"因應「開發部特選牌組」的情報，新增部分卡牌",
				],	
			},
			{	
				date : "2023/03/02",
			...
			{	
				date : "2023/02/24",
				log : [ 
						"新增DMEX-17【メモリアルパック 究極の章 デュエキングMAX】",
						"新增DMSP-04【デュエマ・ストロング・ドリーム ジョーカーズGR】",
						"新增DMBD-18【レジェンドスーパーデッキ 神歌繚嵐】",
				],	
			},
		],
	};