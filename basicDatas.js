	...
	var cardTypeMapping = {
		...
		map : 
			[
				...
				{	value : "NDC",	text : "NEO夢幻生物",			Jap : "NEOドリーム・クリーチャー",				Location : "M", horizontal : false,	main:true,	descript : "當此生物下方有生物卡牌時，則將此生物視為NEO進化生物，且我方場上同名生物只能存在一隻的特別生物"						},
	...
	var updateLog = {
		...
		logAndDate : [
			...
			{	
				date : "2025/08/08",
				log : [ 
						"新增DM25-BD1【ドリーム英雄譚デッキ ボルシャックの書】的資料",
						"新增DM25-BD2【ドリーム英雄譚デッキ アルカディアスの書】的資料",
						"新增DMRP-12【超天篇 拡張パック第4弾 超超超天！覚醒ジョギラゴン vs. 零龍卍誕】的資料",
				],	
			},
			{	
				date : "2025/07/21",
			...
			{	
				date : "2025/07/20",
				log : [ 
						"新增DM25-EX1【デュエル・マスターズTCG 愛感謝祭 ヒロインBEST】的資料",
				],	
			},
		],
	};