	...
	var cardTypeMapping = {
		...
		map : 
			[
				...
				{	value : "NC",	text : "NEO生物",			Jap : "NEOクリーチャー",					Location : "G", horizontal : false,	main:false,	descript : "當此生物下方有生物卡牌時，則將此生物視為進化生物"							},
				{	value : "GRC",	text : "GR生物",			Jap : "GRクリーチャー",						Location : "G", horizontal : false,	main:false,	},
				{	value : "NGRC",	text : "NEO GR生物",		Jap : "NEO GRクリーチャー",					Location : "M", horizontal : false,	main:false,	descript : "當此生物下方有生物卡牌時，則將此生物視為進化生物"							},
				...
				{	value : "DHF",	text : "龍心要塞",			Jap : "ドラグハート・フォートレス",			Location : "P", horizontal : true,	main:false,	},
				{	value : "XC",	text : "放浪生物",			Jap : "エグザイル・クリーチャー",			Location : "M", horizontal : false,	main:false,	},
				{	value : "EXC",	text : "進化放浪生物",		Jap : "進化エグザイル・クリーチャー",		Location : "M", horizontal : false,	main:false,	},
				{	value : "PC",	text : "精神生物",			Jap : "サイキック・クリーチャー",			Location : "P", horizontal : false,	main:true,	},
				...
				{	value : "FF",	text : "禁斷領域",			Jap : "禁断フィールド",						Location : "M", horizontal : true,	main:false,	},
				{	value : "FeF",	text : "妖精領域",			Jap : "フェアリー・フィールド",				Location : "M", horizontal : true,	main:false,	},
				{	value : "SI",	text : "禁斷的鼓動",		Jap : "禁断の鼓動",							Location : "I", horizontal : false,	main:false,	},
				{	value : "SC",	text : "禁斷生物",			Jap : "禁断クリーチャー",					Location : "I", horizontal : false,	main:false,	},
				{	value : "FSC",	text : "最終禁斷生物",		Jap : "最終禁断クリーチャー",				Location : "I", horizontal : false,	main:false,	},
				{	value : "FFF",	text : "最終禁斷領域",		Jap : "最終禁断フィールド",					Location : "I", horizontal : true,	main:false,	},
				...
				{	value : "KCL",	text : "王的靈核",			Jap : "キング・セル",						Location : "M", horizontal : false,	main:true,	},
				...
				{					text : "領域",				Jap : "フィールド",							descript : "泛指D2フィールド、最終禁断フィールド、幸せのフィールド等領域卡"				},
	...
	var updateLog = {
		...
		logAndDate : [
			{	
				date : "2023/03/20",
				log : [ 
						"新增「DMBD-21 クロニクル・ダークサイド・デッキ 「終焉」」的資料",
						"調整GR生物、零龍星雲、大小禁斷的牌組顯示方式",	
				],	
			},
			{	
				date : "2023/03/17",
				log : [ 
						...
						"新增「DMBD-22 クロニクル・ダークサイド・デッキ 「零誕」」的資料",
						"調整「DM22-BD2 開発部セレクションデッキ 「7軸ガチロボ」」的資料",
						"調整「DM22-BD3 開発部セレクションデッキ 「光水火鬼羅.Star」」的資料",
						"訂正「俺神豚 ブリタニア」的卡種",
				],	
			},
			{	
			...
			{	
				date : "2023/03/15",
				log : [ 
						"訂正【深淵の壊炉 マーダン=ロウ】的能力",
				],	
			},
			{	
				date : "2023/03/13",
				log : [ 
						"新增「DMPCD-02デュエマプレイス・コラボデッキ 竜装の武者＆魔弾の騎士」",
				],	
			},
		],
	};