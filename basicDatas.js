	...
	var updateLog = {
		...
		logAndDate : [
			{	
				date : "2023/09/16",
				log : [ 
						"新增【アビス・レボリューション 第3弾 「魔覇革命」】的資料",
				],	
			},
			{	
				date : "2023/09/08",
				log : [ 
						"新增【スペシャルプロモパック2023 vol.1】的資料",
						"新增【DM23-SD3 スタートWINデッキ 革命・アメイジン・マジック】的資料",
						"調整單篇卡表匯出格式的卡牌大小",
						"訂正【葬磁縫合 セブ・シュテロン Λ】與【死神の精度 レイン】的能力"
				],	
			},
			{	
				date : "2023/09/07",
				log : [ 
						"新增【スペシャルプロモパック2022 vol.2】的資料",
				],	
			},
			{	
				date : "2023/08/31",
				log : [ 
						"訂正【龍素記号 Ea パーレンチャン】的卡名",
				],	
			},
		],
	};