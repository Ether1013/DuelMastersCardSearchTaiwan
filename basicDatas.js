...
//... (接續上一段被截斷的程式碼)
	...
	const cardTypeMapping = {
		...
		init: function() {
			const initialData = [
				...
				{	value : "PC",	text : "精神生物",			Jap : "サイキック・クリーチャー",					Location : "P", horizontal : false,	parents: [ "P","C" ],		main:true,	},
				...
				{	value : "PF",	text : "精神領域",			Jap : "サイキック・フィールド",					Location : "P", horizontal : true,	parents: [ "P","F" ],		main:false,	},
	...
	const sanctuary = {
		...
		init: function() {
			const s1Data = [
				"不敵怪人アンダケイン", "インフィニティ・ドラゴン", "エメラル", "エンペラー・キリコ", "斬隠オロチ", "海底鬼面城", "カラフル・ダンス",
				"魔導管理室 カリヤドネ/ハーミット・サークル", "怨念怪人ギャスカ", "疾封怒闘 キューブリック", "蛇手の親分ゴエモンキー!", "“轟轟轟”ブランド", "再誕の社", "瞬封の使徒サグラダ・ファミリア", "Ｓ級原始 サンマッド", "次元の霊峰", 
				"ジョット・ガン・ジョラゴン", "ストリーミング・シェイパー", "セイレーン・コンチェルト", "凄惨なる牙 パラノーマル", "暗黒鎧 ダースシスK", "常勝ディス・オプティマス", "デビル・ドレーン", "蒼き団長 ドギラゴン剣", 
				"MEGATOON・ドッカンデイヤー", "龍素知新", "ドリル・スコール", "腐敗勇騎ドルマークス", "侵革目 パラスラプト", "バロン・ゴーヤマ", "ハイドロ・ハリケーン", "超竜バジュラ", "魔龍バベルギヌス", 
				"光牙忍ハヤブサマル", "フェアリー・ギフト", "黒神龍ブライゼナーガ", "復讐 ブラックサイコ", "邪帝斧 ボアロアックス", "暴龍警報", "ホーガン・ブラスター", "ポジトロン・サイン", "奇跡の精霊ミルザム", 
				"単騎連射 マグナム", "魔天降臨", "予言者マリエル", "陰陽の舞", "BAKUOOON・ミッツァイル", "時の法皇 ミラダンテXII", "メガ・マナロック・ドラゴン", "Dの牢閣 メメント守神宮", "盗掘人形モールス",
				"ラッキー・ダーツ", "熱き侵略 レッドゾーンZ", "ミラクルとミステリーの扉", "竜魔神王バルカディア・NEX（ネックス）", "樹食の超人", "超七極 Gio/巨大設計図", "暗黒鎧 ザロスト", "ガル・ラガンザーク", "一なる部隊 イワシン", 
				"絶望神サガ", "超神星アポロヌス・ドラゲリオン", "幻緑の双月/母なる星域", "「無月」の頂 ＄スザーク＄", "天命龍装 ホーリーエンド/ナウ・オア・ネバー", "緊急再誕", "邪幽 ジャガイスト", "瞬閃と疾駆と双撃の決断", "マーシャル・クイーン", 
				...
				"愛銀河マーキュリー・スターフォージ","闇王ゼーロ","ゾンビポンの助","お目覚めメイ様","我竜塔第一層 セイント・キャッスル","俳句爵 Drache der’Bande","レヴィヤの地版","轟く覚醒 レッドゾーン・バスター","蒼き覚醒 ドギラゴンX","ミラクル1 ドレミ24"
			];
			...
			const s0Data = [
				...
				"フューチャー・スラッシュ", "転生プログラム", "ベイB ジャック", "ヘブンズ・フォース", "ヘル・スラッシュ", "無双竜機ボルバルザーク", "マリゴルドⅢ", "ヨミジ 丁-二式", "音精 ラフルル", 
				"レアリティ・レジスタンス", "ロスト・チャージャー", "ダンディ・ナスオ", "希望のジョー星", "生命と大地と轟破の決断", "機術士ディール/「本日のラッキーナンバー！」", "神の試練",
				"【今すぐ】うわっ…相手の攻撃止めすぎ…？【クリック】","ビックリ・イリュージョン","フェアリー・ギフト","目的不明の作戦","蝕王の晩餐",
			];
	...
	const nickNamesMap = {
		...
		init: function() {
			const initialData = [
				...
				{ realName : "ボルシャック・ドリーム・ドラゴン", 			nickNames : [ "波夢" ]},
				{ realName : "ドリーム・ボルメテウス・ホワイト・ドラゴン", 	nickNames : [ "夢波" ]},
				{ realName : "希望の太陽 マイハマタワー", 			nickNames : [ "舞濱塔" ]},
				{ realName : "パルフェ・ルピア / 「あとはたのんだぞ」", 	nickNames : [ "鳥車","車鳥" ]},
				{ realName : "傷だらけの革命 スカーレッドゾーン", 		nickNames : [ "傷車" ]},
				{ realName : "禁断の轟速 ブラックゾーン", 			nickNames : [ "禁斷車" ]},
				{ realName : "轟く邪道 レッドゾーン", 				nickNames : [ "邪車" ]},
				...
				{ realName : "真気楼と誠偽感の決断", 			nickNames : [ "棒棒糖" ]},
				{ realName : "瞬閃と疾駆と双撃の決断", 			nickNames : [ "完美火" ]},
				{ realName : "轟䡛合体 ゴルギーオージャー", 			nickNames : [ "合體車" ]},
				{ realName : "アーテル・ゴルギーニ", 				nickNames : [ "黑車" ]},
				{ realName : "ガチャンコ  ガチロボ", 				nickNames : [ "機器人" ]},
				{ realName : "「修羅」の頂 VAN・ベートーベン", 		nickNames : [ "貝多芬","修羅頂" ]},
				{ realName : "龍世界 ドラゴ大王", 				nickNames : [ "龍大王" ]},
				{ realName : "「正義星帝」 <ライオネル.Star>", 		nickNames : [ "獅子星" ]},
				{ realName : "メンデルスゾーン", 					nickNames : [ "MZ" ]},
				{ realName : "アルカディアス・モモキング", 			nickNames : [ "阿卡桃" ]},
				{ realName : "禁断英雄 モモキングダムX", 			nickNames : [ "禁斷英雄","禁桃","禁斷桃" ]},
				{ realName : "アリスの突撃インタビュー", 			nickNames : [ "採訪" ]},
				{ realName : "ピザスターのアンティハムト", 			nickNames : [ "披薩鼠","披薩倉鼠" ]},
				{ realName : "∞龍 ゲンムエンペラー", 				nickNames : [ "無限龍" ]},
				{ realName : "キャンベロ ＜レッゾ.Star＞", 		nickNames : [ "狗車" ]},
				...
				{ realName : "蒼き守護神 ドギラゴン閃", 			nickNames : [ "團閃" ]},
				{ realName : "蒼き夢双 ドギラゴン天", 			nickNames : [ "團天" ]},
				{ realName : "紅き団長 ドギラゴン悪", 			nickNames : [ "團惡" ]},
