	...
	var updateLog = {
		...
		logAndDate : [
			{	
				date : "2025/03/14",
				log : [ 
						"新增DM24-EX4【にじさんじコラボ・マスターズ「異次元の超獣使い」】的資料",
				],	
			},
			{	
				date : "2025/02/20",
				log : [ 
						"訂正DM24-BD5與DM24-BD6的雙極卡標成超化獸的問題",
				],	
			},
			{	
				date : "2025/02/14",
				log : [ 
						"新增DM24-BD5【エキサイティング・デュエパ・デッキ アセビと異世界フェアリーたち】的資料",
						"新增DM24-BD6【エキサイティング・デュエパ・デッキ ツラトゥストラは水晶と語らう】的資料",
						"訂正卡牌資料切去DM24-EX3時會亂跑的BUG",
				],	
			},
			{	
				date : "2025/01/20",
				log : [ 
						"訂正【禁断英雄 モモキングダムX】的能力",
						"新增DM24-EX3的資料",
						"新增台灣CS2的前四名資料",
				],	
			},
