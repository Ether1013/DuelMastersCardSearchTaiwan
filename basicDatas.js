	...
	var cardTypeMapping = {
		...
		map : 
			[
				...
				{	value : "PC",	text : "精神生物",			Jap : "サイキック・クリーチャー",			main:true,	},
				{	value : "EPC",	text : "精神進化生物",		Jap : "進化サイキック・クリーチャー",		main:false,	},
				{	value : "SPC",	text : "精神超級生物",		Jap : "サイキック・スーパー・クリーチャー",	main:false,	},
	...
	var updateLog = {
		...
		logAndDate : [
			...
			{	
				date : "2023/01/10",
				log : [ 
						"新增2023/01/10 DM店員 TW-018【火單波夏克＠柚子 From 這裡有桌遊】與TW-019【深淵＠文聖 From 一刻館】",
				],	
			},
			{	
				date : "2023/01/09",
				log : [ 
						"訂正【将龍剣 ガイアール】與【猛烈将龍 ガイバーン】的預設卡圖",
						"異動NET-038的內容",
						"新增文字匯入牌組功能範例文字",
						"新增TW-017【RedZoneKindom＠Richard】",
				],	
			},
			{	
				date : "2023/01/06",
				log : [ 
						"因應移站、更改Facebook留言板相關設定",
				],	
			},
			{	
				date : "2023/01/01",
				log : [ 
						"異動OF-Y22 SPP-1【スペシャルプロモパック2022 vol.1】為台灣卡池",
				],	
			},
		],
	};