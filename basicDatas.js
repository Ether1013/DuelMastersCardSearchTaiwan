	...
	const sanctuary = {
		...
		init: function() {
			const s1Data = [
				...
				"光牙忍ハヤブサマル", "フェアリー・ギフト", "黒神龍ブライゼナーガ", "禁断機関 VV-8", "復讐 ブラックサイコ", "邪帝斧 ボアロアックス", "暴龍警報", "ホーガン・ブラスター", "ポジトロン・サイン", 
	...
	const updateLog = {
		...
		logAndDate : [
			...
			{	
				date : "2026/06/15",
				log : [ 
						"新增DM26-RP2【燃えろ禁断！逆転のドギラゴン革命!!】的資料",
				],	
			},
			{	
				date : "2026/05/15",
				log : [ 
						"新增DM26-EX1【ますますつよいパック 25の援軍】的資料",
				],	
			},
		],
	};
