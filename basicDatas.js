	...
	var updateLog = {
		...
		logAndDate : [
			{	
				date : "2023/03/23",
				log : [ 
						"新增「DMPCD-03 デュエマプレイス・コラボデッキ 激竜の英雄＆邪眼の始祖」的資料",
				],	
			},
			{	
				date : "2023/03/22",
				log : [ 
						"桌機新增快捷鍵功能，詳情請洽發開者",
						"新增功能：桌機版雙擊列表卡名即可複製卡名",
						"新增CardRush找卡連結",
						"訂正【不死（ゾンビ） マトメル】與【不死（ゾンビ） ゾンビーバー】的預設卡圖",
				],	
			},
			{	
				date : "2023/03/21",
				log : [ 
						"新增「DMRP-22 王来MAX最終弾 切札!マスターCRYMAX!!」的資料",
						"新增「DMEX-19 マスター・ファイナル・メモリアル・パック」的資料",
				],	
			},
			{	
				date : "2023/03/20",
				log : [ 
						...
						"調整GR生物、零龍星雲、大小禁斷的列表顯示方式",	
						"調整雙面卡的列表方式",
						"新增「台灣俺嘉年華2023」前四名卡表(NET-054~NET-057)",
						"訂正【イデア・パラドックス】的能力",
				],	
			},
			{	
