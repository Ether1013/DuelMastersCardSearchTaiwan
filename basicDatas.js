	...
	var updateLog = {
		...
		logAndDate : [
			...
			{	
				date : "2023/02/17",
				log : [ 
						"新增DMRP-18【禁時王の凶来】的內容",
						"新增DMEX-16【技の章 英雄戦略パーフェクト20】的內容",
						"新增DMBD-16【決闘!! ボルシャック･デュエル】的內容",
						"新增DMBD-17【熱血!! アウトレイジ・ビクトリー】的內容",
						"新增DMSD-19【ハイドのディスペクターN・EXT】的內容",
						"新增DM22-EX2【ヒーローズ・ダークサイド・パック ～闇のキリフダたち～】的內容",
				],	
			},
			{	
				date : "2023/02/16",
			...
			{	
				date : "2023/02/14",
				log : [ 
						"新增DMSP-02【超獣王来烈伝】的內容",
						"新增DMSD-17【ジョーのスター進化】的內容",
						"新增DMSD-18【ジェンドルのディスペクター】的內容",
				],	
			},
			{	
				date : "2023/02/08",
